        ...
        var parseOption = function (opt) {
            ...
            if (opt !== undefined) {
                ...
                if (attrTitle !== "") {
                    ...
                    depth = (isJson && settings.jsonTitle) ? obj[0].depth : depth;
                    index = opt.index;
                }
                ...
                depth = $(opt).prop("data-depth") || $(opt).data("depth") || (depth || "");
                index = $(opt).index();
            }
        ...
        var createChild = function (opt) {
            ...
            if (parsed.depth > 0) {
                if (!obj.style)
                    ...
                    obj.style += ';';
                obj.style += 'padding-left: ' + 20 * parsed.depth + 'px;';
            }
...
$(document).on('turbolinks:load', function () {
    $("body select").msDropDown({roundedCorner: false, visibleRows: 15, animStyle: 'none'});
});
