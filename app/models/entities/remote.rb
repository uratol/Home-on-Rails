...
# Удалённое устройство - это, как правило, точно такой же микрокомпьютер с аналогичным web-сервером.
# Взаимодействие осуществляется при помощи GET-запроса.
# В атрибуте *address* должен быть прописан DNS или IP-адрес удалённого устройства
...
# Если пароль администратора в дальнейшем будет изменён, на удалённом сервере нужно просто удалить этот логин и
